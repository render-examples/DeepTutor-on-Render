...
def test_resolve_imagegen_config_fills_provider_default_base(monkeypatch) -> None:
    # volcengine is an OpenAI-compatible gateway keyed on OPENAI_API_KEY.
    monkeypatch.setenv("OPENAI_API_KEY", "ark-key")
