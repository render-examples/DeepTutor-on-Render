...
def test_resolve_tts_config_uses_provider_default_base(monkeypatch) -> None:
    # siliconflow is an OpenAI-compatible gateway keyed on OPENAI_API_KEY.
    monkeypatch.setenv("OPENAI_API_KEY", "sf-key")
